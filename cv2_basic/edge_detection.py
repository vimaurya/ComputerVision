...
img_edge_dilate = cv.dilate(img_edge, np.ones((3,3), dtype=np.int8), iterations=1)

img_edge_erode = cv.erode(img_edge_dilate, np.ones((3,3), dtype=np.int8), iterations=1)
